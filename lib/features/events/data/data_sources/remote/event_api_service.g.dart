...
class _EventApiService implements EventApiService {
  ...
  @override
  Future<HttpResponse<ApiResponseModel>> getEvents() async {
  ...
  @override
  Future<HttpResponse<ApiResponseModel>> getTodayEvent() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<ApiResponseModel>> getEvent(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'id': id};
